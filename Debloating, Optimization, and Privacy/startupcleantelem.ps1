...
Set-Content stop "LogiRegistryService"
Set-Content config "LogiRegistryService" start=disabled
Set-Content stop "Razer Game Scanner Service"
Set-Content config "Razer Game Scanner Service" start=disabled
...
Set-Content config wlidsvc start=disabled
...
Set-Content stop "VSStandardCollectorService150"
net stop "VSStandardCollectorService150"
Set-Content config "VSStandardCollectorService150" start=disabled
