...
Set-SmbServerConfiguration -MaxChannelPerSession 16
#Remove Onedrive
...
Start-Process C:\\Windows\\System32\\Reg.exe -ArgumentList "Unload HKLM\\Temp" -Wait Start-Process -FilePath C:\\Windows\\Explorer.exe 
Explorer.exe
#Disable Cortana
